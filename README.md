...
Sistema web de gerenciamento de equipamentos e chamados. Utilizando propriedades do Atomic Design para reduzir a necessidade de gerar manualmente CRUD's. Dessa forma também possibilitando mais agilidade na manutenção e evolução do projeto.
...
Integrado com a API REST do [backend do mesmo projeto](https://github.com/LucasFonteneleDev/gerenciamento-Ti). 